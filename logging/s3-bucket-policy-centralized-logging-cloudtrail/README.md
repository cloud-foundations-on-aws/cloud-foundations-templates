# Centralized Logging CloudTrail S3 Bucket Policy

The following S3 Bucket policy will enable an S3 bucket to receive AWS CloudTrail events from an Organization CloudTrail Trail.
